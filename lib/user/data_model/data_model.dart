...
List<CommonCardModel> MedicineCategoryCardModelDummyData = [
  CommonCardModel(
      ...
      img: "assets/images/doctor1.png"),
  CommonCardModel(
      mainText: "Skin Care", subText: "", img: "assets/images/doctor1.png"),
  CommonCardModel(
  ...
  CommonCardModel(
      ...
      img: "assets/images/doctor1.png"),
  CommonCardModel(
      mainText: "Baby Care", subText: "", img: "assets/images/doctor1.png"),
  CommonCardModel(
      mainText: "Pain Relief", subText: "", img: "assets/images/doctor1.png"),
  CommonCardModel(
      mainText: "Diabetic Care", subText: "", img: "assets/images/doctor1.png"),
  CommonCardModel(
...
List<CommonCardModel> CommonServiceModelDummyData = [
  ...
  CommonCardModel(
      mainText: "Surgeries", img: "assets/doctors/femaleDoctor1.png"),
];
...
List<DrawerMenuModel> commonSymptoms = [
  ...
  DrawerMenuModel(
      Header: "Diabetes \nManagement",
      imageUrl: 'assets/symptoms/diabetes.png'),
  DrawerMenuModel(
      Header: "Ayurveda ", imageUrl: 'assets/symptoms/ayurveda.png'),
  DrawerMenuModel(Header: "Cancer", imageUrl: 'assets/symptoms/cancer.png'),
  DrawerMenuModel(
      Header: "Urinary \nIssues",
      imageUrl: 'assets/symptoms/urinaryInfectin.png'),
  DrawerMenuModel(
...
List<DrawerMenuModel> skinAndHair = [
  DrawerMenuModel(
      Header: "Psoriasis/Scaly patches", imageUrl: 'assets/skin/eczema.png'),
  DrawerMenuModel(
  ...
  DrawerMenuModel(
      Header: "Vitiligo/ white patches", imageUrl: 'assets/skin/eczema.png'),
...
List<DrawerMenuModel> womensHealthConcerns = [
  ...
  DrawerMenuModel(
      Header: "Vaginal Discharge",
      imageUrl: 'assets/women/vaginalDischarge.png'),
  DrawerMenuModel(
      Header: "Irregular Periods",
      imageUrl: 'assets/women/irregularPeriods.png'),
  DrawerMenuModel(
      Header: "Urinary Tract Infection",
      imageUrl: 'assets/women/urinaryInfectin.png'),
];

List<DrawerMenuModel> chronicProblems = [
  DrawerMenuModel(Header: "Diabetes", imageUrl: 'assets/chronic/diabetes.png'),
  ...
  DrawerMenuModel(
      Header: "Insomnia/sleeplessness",
      imageUrl: 'assets/chronic/insomnia.png'),
  DrawerMenuModel(
...
List<DrawerMenuModel> boneAndJoint = [
  DrawerMenuModel(Header: "Knee Pain", imageUrl: 'assets/bone/kneePain.png'),
  ...
  DrawerMenuModel(Header: "Carpal Tunnel", imageUrl: 'assets/bone/carpal.png'),
];
...
List<ShowOffCardModel> showoffcarddata = [
  ShowOffCardModel(
      icon: const Icon(Icons.person), text1: 'Our Users', text2: '30 Crores'),
  ShowOffCardModel(
...
List<ShowOffCardModel> showoffcarddata2 = [
  ShowOffCardModel(
      icon: const Icon(Icons.person), text1: 'Our Users', text2: '1 Crore+'),
  ShowOffCardModel(
      icon: const Icon(Icons.medical_services),
      text1: 'Our Products',
      text2: '1 Lakh'),
  ShowOffCardModel(
      icon: const Icon(Icons.star), text1: 'Original Products', text2: '100%'),
  ShowOffCardModel(
      icon: const Icon(Icons.message_outlined),
      text1: 'Secured Transaction',
      text2: '5 Lakh+'),
];
...
List<OrderProductModel> orderProductData = [
  OrderProductModel(
      subText: 'By Reckitt Benckiser',
      header: 'Dettol Squeezy Hand Wash 100ml',
      price: '30',
      image: "https://images.unsplash.com/photo-1607077792448-17b60bcca65f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80",
  ),
  OrderProductModel(
    subText: 'By Reckitt Benckiser',
    header: 'Dettol Squeezy Hand Wash 100ml',
