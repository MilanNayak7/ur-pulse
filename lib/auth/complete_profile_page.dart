        ...
        child: Container(
          ...
          child: ListView(
            children: [
              ...
              CupertinoButton(
                onPressed: () {
                  Provider.of<AuthProvider>(context,listen:false).updateAuthProvider(widget.userModel);
                  // UserModel userModel = Provider.of<AuthProvider>(context,listen:false).userModel;
                  // print("UserModel  id is   ${userModel.uid}");
                  Provider.of<AuthProvider>(context,listen:false).updateUserProvider(widget.firebaseUser);
                  // User u = Provider.of<AuthProvider>(context,listen:false).user;
                  // print("Firebase  id is   ${u.uid}");
                  checkValues();
