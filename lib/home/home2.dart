...
import '../common/card/medical_card_widget.dart';
import '../common/card/product_card.dart';
  ...
  InkWell posterOneContainer() {
    return InkWell(
      ...
      child: Card(
        ...
        color: Colors.blue,
        child: Padding(
          padding: EdgeInsets.symmetric(vertical:Dimensions.d3),
          child: Row(
                ...
                children: [
                  ...
                  SizedBox(
                   ...
                   Card(
                    color:Colors.indigo,
                    child:  Padding(
                      padding: EdgeInsets.symmetric(horizontal:Dimensions.d2,vertical:Dimensions.d2),
                      child: const Text(
                        'Know More',
